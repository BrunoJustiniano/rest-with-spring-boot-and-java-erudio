...
@Table(name = "books") //traduz o nome da classe para o nome final da tabela (pode ser alterado se julgar necessário).
public class Book implements Serializable{
	...
	@Column(nullable = false) // Se o nome da coluna for igual ao nome do objeto Java, não é necessário informar o nome da coluna
