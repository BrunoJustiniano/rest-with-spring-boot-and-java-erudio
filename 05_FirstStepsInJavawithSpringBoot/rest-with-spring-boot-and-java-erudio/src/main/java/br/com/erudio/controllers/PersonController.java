...
public class PersonController {
	...
	@Operation(summary = "Adds a new Person",
		description = "Adds a new Person by a JSON, XML or YML representation of the person!",
		tags = {"People"},
		responses = {
			@ApiResponse(description = "Sucess", responseCode = "200", 
				content = @Content(schema = @Schema(implementation = PersonVO.class))
	...
	description = "Updates a new Person by parsing in a JSON, XML or YML representation of the person!",
	tags = {"People"},
	responses = {
