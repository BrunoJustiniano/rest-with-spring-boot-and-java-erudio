...
public class BookController {
	...
	@GetMapping(value =  "/findBookByAuthor/{author}",
			produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML })
	@Operation(summary = "Finds books by author", description = "Finds people by name",
	tags = {"Author"},
	responses = {
			@ApiResponse(description = "Sucess", responseCode = "200", 
					content = {
	...
	/*public List<PersonVO> findAll() {
		return service.findAll();
	}*/ //retorna todo o conteudo do banco
	
	//metodo para fazer paginação
	...
	@Operation(summary = "Adds a new Book",
		description = "Adds a new Book by a JSON, XML or YML representation of the book!",
		tags = {"Book"},
		responses = {
			@ApiResponse(description = "Sucess", responseCode = "200", 
				content = @Content(schema = @Schema(implementation = BookVO.class))
	...
	description = "Updates a new Book by a JSON, XML or YML representation of the book!",
	tags = {"Book"},
	responses = {
	...
	description = "Deletes a Book by a JSON, XML or YML representation of the book!",
	tags = {"Book"},
	responses = {
		@ApiResponse(description = "No content", responseCode = "204", content = @Content()
		),
