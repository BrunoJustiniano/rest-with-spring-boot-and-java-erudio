...
public class BookControllerJsonTest extends AbstractIntegrationTest {
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
		...
		assertTrue(content.contains("\"prev\":{\"href\":\"http://localhost:8888/api/book/v1?limit=12&direction=asc&page=0&size=12&sort=author,asc\"}"));
		assertTrue(content.contains("\"self\":{\"href\":\"http://localhost:8888/api/book/v1?page=1&limit=12&direction=asc\"}"));
		...
		assertTrue(content.contains("\"last\":{\"href\":\"http://localhost:8888/api/book/v1?limit=12&direction=asc&page=1&size=12&sort=author,asc\"}}"));
		
		assertTrue(content.contains("\"page\":{\"size\":12,\"totalElements\":15,\"totalPages\":2,\"number\":1}}"));
	}
